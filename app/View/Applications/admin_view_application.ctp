	...
	<div class="row">
		<div class="col-md-10">
							...
							<div class="container borderTitle">
								...
								<div class="form-group row miniAreaBox">
									...
									<div class="col-sm-10 normalFont">
										<div id="appName" class="" ><?= $myApplication['Application']['name'] ?></div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-10 normalFont">
										<div id="appInfo"><?= $myApplication['Application']['info'] ?></div>
										<small class="form-text text-muted">
											hoge
										</small>
									</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<div id="appIosURL" class="" ><a href="<?= $myApplication['Application']['ios_url'] ?>" target="_blank"><?= $myApplication['Application']['ios_url'] ?></a></div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<div id="appIosURL" class="" ><a href="<?= $myApplication['Application']['android_url'] ?>" target="_blank"><?= $myApplication['Application']['android_url'] ?></a></div>
										<small class="form-text text-muted">Google Play Store</small>
									</div>
								</div>

								<div class="text-right p-1">
									<a href="/admin/applications/editApplication/<?= $myApplication['Application']['id'] ?>" class="btn btn-warning">編集</a>
								</div>
			...
			<div class="list-group p-3">
				<a href="/admin/events/listObjects/<?= $myApplication['Application']['id'] ?>" class="list-group-item list-group-item-action bg-warning text-light">
					イベント一覧・改廃
				</a>
